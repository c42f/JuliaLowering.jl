...
31  (goto label₃₄)
32  slot₁/idx
33  (call top.setindex! %₇ %₂₈ %₃₂)
34  slot₁/idx
35  (= slot₁/idx (call top.add_int %₃₄ 1))
36  (= slot₂/next (call top.iterate %₁ %₂₆))
37  slot₂/next
38  (call core.=== %₃₇ core.nothing)
39  (call top.not_int %₃₈)
40  (gotoifnot %₃₉ label₄₂)
41  (goto label₂₃)
42  (= slot₃/next (call top.iterate %₂ %₁₇))
43  slot₃/next
44  (call core.=== %₄₃ core.nothing)
45  (call top.not_int %₄₄)
46  (gotoifnot %₄₅ label₄₈)
47  (goto label₁₅)
48  (return %₇)
